...
const TechsPage = () => {
  return (
    ...
    >
      <h1 className="text-3xl sm:text-3xl md:text-4xl font-bold text-center text-white mt-10">
        Technologies
      </h1>
      <p className="text-xl sm:text-base md:text-lg lg:text-xl text-white text-justify">
